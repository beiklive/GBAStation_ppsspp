...
/// @brief Display size (context-dependent on TicoDisplayMode)
///   Integer → 1x, 2x, Auto
///   Display → Stretch, 4:3, 16:9, Original
enum class TicoDisplaySize
{
    // Display sizes (0-3)
    Stretch = 0,
    _4_3 = 1,
...
/// @brief Overlay UI for ppsspp with tico styling
class TicoOverlay
{
public:
    TicoOverlay();
